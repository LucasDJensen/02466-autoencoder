...
#autoencoder = tf.keras.models.load_model('ta_1000.h5')
autoencoder.save('ta_1000.h5')
...
plt.legend()
plt.grid(True)
plt.savefig("validation_signal_reconstructed_1000.png")
...
plt.legend()
plt.savefig("train_val_loss_1000.png")
...
tf.io.write_file('ta_1000_features.tfrecord', serialized_tensor)
...
joblib.dump(gmm, 'ta_1000_gmm.pkl')
...
plt.title('ROC Curve')
plt.legend()
plt.savefig("ta_1000_roc_auc_curve")
