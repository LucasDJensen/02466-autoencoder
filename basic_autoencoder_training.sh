...
### –- specify queue --
### -- set the job Name --
#BSUB -J spindle_training_CNN_kornum
...
#BSUB -o basic_autoencoder_training_%J.out
#BSUB -e basic_autoencoder_training_%J.err
...
python /zhome/01/4/167733/autoencoder_code/train_autoencoder.py