...
plt.legend()
plt.savefig("dense_ae_train_val_loss.png")
...
tf.io.write_file('dense_ae_features.tfrecord', serialized_tensor)
...
joblib.dump(gmm, 'dense_ae_gmm.pkl')
...
plt.title('ROC Curve')
plt.legend()
plt.savefig("dense_ae_roc_auc_curve")
