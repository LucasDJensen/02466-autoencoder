...
### –- specify queue --
### -- set the job Name --
#BSUB -J one_autoencoder_training
...
#BSUB -o one_autoencoder_training_%J.out
#BSUB -e one_autoencoder_training_%J.err
...
python /zhome/01/4/167733/autoencoder_code/train_dense_autoencoder.py