...
# ==================================================
model = Autoencoder(input_shape, activation_function = "elu", latent_dim = latent_dim, learning_rate = learning_rate)
...
plt.legend()
plt.savefig("image_ae_train_val_loss.png")
...
tf.io.write_file('image_ae_features.tfrecord', serialized_tensor)
...
joblib.dump(gmm, 'image_ae_gmm.pkl')
...
plt.title('ROC Curve')
plt.legend()
plt.savefig("image_ae_roc_auc_curve")
